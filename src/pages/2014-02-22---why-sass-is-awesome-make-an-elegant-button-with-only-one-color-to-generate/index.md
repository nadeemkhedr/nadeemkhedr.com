...
I have been using SASS in my latest project & I have to say its pretty AWESOME! , the CSS code is nicely structured and organized into multiple files using [OO CSS](http://oocss.org/ "Object Oriented CSS") principles *(Maybe i’ll write about this in another article)*
...
* Mixins *( you can read about it [here](http://sass-lang.com/guide "SASS Guide"))*
* Our SASS rules
